...
public class Facebook {
	...
	//			.sendKeys(password);
		driver.findElement(By.xpath("//form[@class='_featuredLogin__formContainer']/div[1]/div[2]/input")).sendKeys(password);
		
		
		//driver.findElement(By.xpath("//input[contains(@value,'Log I')]")).click();
		driver.findElement(By.xpath("//form[@class='_featuredLogin__formContainer']//following-sibling::div[2]/button")).click();
		Thread.sleep(50000);
